...
<table class="ui unstackable table">
    ...
    <form class="ui form" method="POST" action="">
        <div class="field">
            <?php for($i=0; $i<count($order_ingredient_name); $i++):?>
                <tr>
                    <td>
                        <div class="field">
                            <input readonly type="text" name="<?php print $order_ingredient_name[$i]?>"
                                   value="<?php print $order_ingredient_name[$i]?>">
                        </div>
                    </td>
                    <td>
                        <div class="field">
                            <input readonly type="text" name="<?php print $order_ingredient_name[$i]?>_total"
                                   value="<?php print $order_ingredient_total[$i]?>">
                        </div>
                    </td>
                    <td class="right aligned">
                        <input class="right aligned" readonly type="text" name="<?php print $order_ingredient_name[$i]?>_measure"
                               value="<?php print $order_ingredient_measure[$i]?>">
                    </td>
                </tr>
            <?php endfor;?>
        </div>
        <button class="ui button" type="submit">Buy</button>
    </form>
